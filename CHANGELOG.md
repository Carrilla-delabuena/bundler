...
Bugfixes:
  ...
  - Expand symlinks during Bundler setup to allow Bundler to load correctly when using symlinks in $GEM_HOME ([#6465](https://github.com/bundler/bundler/issues/6465), @ojab, @indirect)
  ...
  - Don't fallback to  temporary when required directories exist already ([#6546](https://github.com/bundler/bundler/issues/6546), @brodock)
